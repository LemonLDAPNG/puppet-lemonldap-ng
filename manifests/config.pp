class lemonldap::config {
	...
	define authbackend($type) {
		exec{'define_auth_backend':
			command => "/usr/share/lemonldap-ng/bin/lemonldap-ng-cli set authentication $type",
